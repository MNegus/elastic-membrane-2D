...
qcc membrane-equation.o ${basilisk_script}.o -O2 -L$BASILISK/gl -L$HOME/local/lib -lvofi -llapacke -llapack -lglutils -lfb_osmesa -lGLU -lOSMesa -lm -fopenmp -g -Wall -pipe -D_FORTIFY_SOURCE=2 -DDUMBGL -o ${basilisk_script}/${basilisk_script} -lm
