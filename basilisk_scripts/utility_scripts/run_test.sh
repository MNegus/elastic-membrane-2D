# run_test.sh
# Runs a Basilisk test code basilisk_script.c (remember to not include the .c 
...
qcc -O2 -L$BASILISK/gl -L$HOME/local/lib -lvofi -lglutils -lfb_osmesa -lGLU -lOSMesa -lm -fopenmp -g -Wall -pipe -D_FORTIFY_SOURCE=2 -DDUMBGL -c ${basilisk_script}.c 
...
qcc ${basilisk_script}.o -O2 -L$BASILISK/gl -L$HOME/local/lib -lvofi -llapacke -llapack -lglutils -lfb_osmesa -lGLU -lOSMesa -lm -fopenmp -g -Wall -pipe -D_FORTIFY_SOURCE=2 -DDUMBGL -o ${basilisk_script}/${basilisk_script} -lm
