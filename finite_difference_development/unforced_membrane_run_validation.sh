...
mkdir validation/unforced_membrane_validation_data
...
do
    ...
    ./run_code.sh exact_homogeneous_membrane.c 

    # Run the mitchell solution
    ./run_code.sh D_FORM_mitchell_fd_membrane.c 

    # Make a new directory in the validation data directory
    rm -r ../validation/unforced_membrane_validation_data/N_MEMBRANE_$N 
    mkdir ../validation/unforced_membrane_validation_data/N_MEMBRANE_$N 

    # Copy parameters file into the data directory
    cp parameters.h ../validation/unforced_membrane_validation_data/N_MEMBRANE_$N 
    cp anim_all.gp ../validation/unforced_membrane_validation_data/N_MEMBRANE_$N 

    # Move outputs into the data directory
    mv exact_outputs ../validation/unforced_membrane_validation_data/N_MEMBRANE_$N/
    mv mitchell_outputs ../validation/unforced_membrane_validation_data/N_MEMBRANE_$N 
...
do
    ...
    # Make a new directory in the validation data directory
    rm -r ../validation/unforced_membrane_validation_data/DT_$DTPOWER
    mkdir ../validation/unforced_membrane_validation_data/DT_$DTPOWER

    # Copy parameters file into the data directory
    cp parameters.h ../validation/unforced_membrane_validation_data/DT_$DTPOWER
    cp anim_all.gp ../validation/unforced_membrane_validation_data/DT_$DTPOWER

    # Move outputs into the data directory
    mv exact_outputs ../validation/unforced_membrane_validation_data/DT_$DTPOWER/
    mv mitchell_outputs ../validation/unforced_membrane_validation_data/DT_$DTPOWER 
