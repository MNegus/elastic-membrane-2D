function save_finite_differences_solution(data_dir, alpha, beta, gamma, epsilon, N_membrane, L, tmax, delta_t)
    ...
    for k = 2 : length(T_VALS)
        ...
        %% Composite timestep
        [w_next_composite, p_composite, w_t_composite, d, d_t, J] ...
            = membrane_timestep(xs, t, w_composite, ...
                w_previous_composite, p_previous_composite, ...
                p_previous_previous_composite, "composite",  ...
