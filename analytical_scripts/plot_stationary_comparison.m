...
% parent_dir = "/media/michael/newarre/elastic_membrane/confirmation_data/gamma_varying/";
analytical_parent_dir = sprintf("%s/analytical_data/alpha_%g-beta_%g-gamma_%g", parent_dir, ALPHA, BETA, GAMMA);
...
% figure(1);
% hold on;
% plot(ts_analytical, 2 * sqrt(ts_analytical), 'linewidth', 2', 'Displayname', 'Analytical stationary');
% plot(stationary_ts_dns, stationary_ds_dns, 'linewidth', 2, 'Displayname', 'DNS stationary');
% plot(ts_dns, ds_dns, 'linewidth', 2, 'Displayname', 'DNS');
% plot(ts_analytical, ds_nm, 'linewidth', 2, 'Displayname', 'Normal modes');
% % plot(ts_analytical, ds_outer, 'linewidth', 2);
% plot(ts_analytical, ds_comp, 'linewidth', 2, 'Displayname', 'FD: Composite');
...
% figure(2);
% hold on;
% plot(ts_analytical, 1 ./ sqrt(ts_analytical), 'linewidth', 2', 'Displayname', 'Analytical stationary');
% plot(ts_analytical, stationary_d_ts_dns, 'linewidth', 2, 'Displayname', 'DNS stationary');
% plot(ts_analytical, d_ts_dns, 'linewidth', 2, 'Displayname', 'DNS');
% plot(ts_analytical, d_ts_nm, 'linewidth', 2, 'Displayname', 'Normal modes');
% % plot(ts_analytical, ds_outer, 'linewidth', 2);
% plot(ts_analytical, d_ts_comp, 'linewidth', 2, 'Displayname', 'FD: Composite');
% legend('location', 'northwest');
% xlabel("t");
% ylabel("d'(t)");
% % set(gca, 'yscale', 'log');
...
if (normal_modes)
    ...
    nm_p_line = animatedline('Color', colors(3, :),'LineWidth', 2, ...
        'Displayname', 'Normal modes');
    stationary_nm_p_line = animatedline('Color', colors(7, :),'LineWidth', 2, ...
        'Displayname', 'Stationary normal modes');
end
...
subplot(3, 1, 3);
stationary_comp_p_line = animatedline('Color', colors(5, :),'LineWidth', 2, ...
        'Displayname', 'Stationary composite');
stationary_dns_p_line = animatedline('color', colors(6, :), 'linewidth', 2, ...
        'Displayname', 'Stationary DNS');
...
for k = IMPACT_TIMESTEP + [51, 451, 1001, 2001] 
    %% Updates time
    t = T_VALS(k);
    t
    k
...
%             clearpoints(stationary_nm_p_line);
%             addpoints(stationary_nm_p_line, xs, stationary_ps_nm);
        end
        ...
        addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));
        % Stationary pressure line
        clearpoints(stationary_comp_p_line);
        addpoints(stationary_comp_p_line, xs, composite_pressure_stationary(xs, t, EPSILON));
%         addpoints(stationary_comp_p_line, xs, outer_pressure_stationary(xs, t, EPSILON));
    end
% 
%     xlim([0, 0.1]);
% 
